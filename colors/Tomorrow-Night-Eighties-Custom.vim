...
let g:colors_name = "Tomorrow-Night-Eighties-Custom"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("javaScriptFunction", s:blue, "", "")
    ...
    " Sy highlighting
    call <SID>X("SignifySignAdd", s:green, s:background, "")
    call <SID>X("SignifySignDelete", s:red, s:background, "")
    call <SID>X("SignifySignChange", s:purple, s:background, "")
