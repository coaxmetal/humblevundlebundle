" Customized version of Base16 themes by Chris Kempson
" Base16 Default (https://github.com/chriskempson/base16)
" Scheme: Chris Kempson (http://chriskempson.com)

if !exists("g:base16_variant")
    let g:base16_variant = "default"
endif

if g:base16_variant == "default"
...
elseif g:base16_variant == "eighties"
    " GUI color definitions
    let s:gui00 = "2d2d2d"
    let s:gui01 = "393939"
    let s:gui02 = "515151"
...
elseif g:base16_variant == "monokai"
    " GUI color definitions
    let s:gui00 = "272822"
    let s:gui01 = "383830"
    let s:gui02 = "49483e"
...
elseif g:base16_variant == "tomorrow"
    " GUI color definitions
    let s:gui00 = "1d1f21"
    let s:gui01 = "282a2e"
    let s:gui02 = "373b41"
...
hi clear
syntax reset
let g:colors_name = "base-16-custom"

" Highlighting function
fun <sid>hi(group, guifg, guibg, guisp, ctermfg, ctermbg, attr)
  if a:guifg != ""
  ...
  if a:guisp != ""
    exec "hi " . a:group . " guisp=#" . s:gui(a:guisp)
  endif
  if a:ctermfg != ""
...
call <sid>hi("Warning",       s:gui0A, s:gui01, "", s:cterm0A, s:cterm01, "")
...
call <sid>hi("Special",      s:gui0F, "", "", s:cterm0F, "", "none")
call <sid>hi("SpecialChar",  s:gui0F, "", "", s:cterm0F, "", "none")
call <sid>hi("Statement",    s:gui0E, "", "", s:cterm0E, "", "none")
...
call <sid>hi("SpellBad",     "", s:gui00, s:gui08, "", s:cterm00, "undercurl")
call <sid>hi("SpellLocal",   "", s:gui00, "", "", s:cterm00, "undercurl")
call <sid>hi("SpellCap",     "", s:gui00, s:gui0A, "", s:cterm00, "undercurl")
